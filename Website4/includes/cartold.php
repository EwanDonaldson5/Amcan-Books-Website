...
if (!empty($_SESSION['cart']))
{
  ...
  echo ' <form><table><thead><tr><th> Total = '.number_format($total,2).'</th></tr><thead>
		...
		<div class"container">
		  <p><input type="submit" name="submit"  value="Update My Cart">
		  <a href="checkout.php?total='.$total.'"  role="button">Continue Reservation</a></p>
		</div></form>';
}
else
# Or display a message.
{ echo '<div class="container"><h2>Your cart is currently empty.</h2></div>' ; }
