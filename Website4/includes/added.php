...
if ( mysqli_num_rows( $r ) == 1 )
{
  ...
  { 
    ...
    echo '<div class="container"><h1> '.$row["desc"].' ticket of the '.$row["time"].' showing of '.$row["item_name"].' has been reserved.</h1>';
  } 
  else
  {
...
echo '<div class="container">
    ...
    <table>
            ...
            <p> <a href="../display.php" role="button">Add Another Ticket</a> <p>
      <br>
